                ...
                <div className="main_nav">
                    <div className="navbar-container">
                        <ul className="listnav">
                            ...
                            <li>
                                <NavLink className="not-active" activeClassName="active" to='/browse/featured' >
                            ...
                            <li>
                                <NavLink className="not-active" activeClassName="active" to='/search' >
                                    <div className="navbar-text">
                            ...
                            <li>
                                <NavLink className="not-active" activeClassName="active" to='/library/playlists' >
